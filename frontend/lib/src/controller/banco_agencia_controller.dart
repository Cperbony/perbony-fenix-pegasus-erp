...
class BancoAgenciaController extends ControllerMVC {
  ...
  static Future<List<BancoAgencia>> getListaBancoAgencia() async {
    List<BancoAgencia> listaBancoAgencia =
        await BancoAgenciaService.consultarLista();
  ...
  static BancoAgenciaPersistindo get bancoAgenciaPersistindo =>
      _persisteBancoAgencia;
  static BancoAgenciaPersistindo _persisteBancoAgencia =
      BancoAgenciaPersistindo();
}
