...
import 'package:perboni_erp_fenix/src/view/pessoa_page.dart';
...
class PessoaDetalhePage extends StatelessWidget {
                        ...
                        showBox(text: 'Exclui esse pessoa?', context: context)
                          ...
                          if (delete)
                            PessoaController.excluir(pessoa)
                                .then((bool delete) {
                              if (delete) PessoaController.refrescarLista();
  ...
  editPessoa(Object pessoa, BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(
        builder: (BuildContext context) => PessoaPage(pessoa: pessoa)));
  }
}
