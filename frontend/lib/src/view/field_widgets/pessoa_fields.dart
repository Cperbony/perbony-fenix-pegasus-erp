...
import 'package:perboni_erp_fenix/src/controller/pessoa_controller.dart';
import 'package:perboni_erp_fenix/src/model/pessoa.dart';
...
class PessoaFieldsPersiste extends PessoaFieldsLista {
  ...
  final GlobalKey<FormState> _formKeyPessoaPersistePage =
      GlobalKey<FormState>();
...
class PessoaFieldsLista extends PessoaFields {
  final GlobalKey<ScaffoldState> scaffoldKeyPessoaListaPage =
      GlobalKey<ScaffoldState>();
}

/// Classe que declara e disponibiliza os FieldWidgets
class PessoaFields {
  FieldWidgets<Pessoa> _fieldId,
      _fieldNome,
      _fieldTipo,
      _fieldSite,
      _fieldEmail,
  ...
  set fieldFornecedor(FieldFornecedor fieldFornecedor) =>
      _fieldFornecedor = fieldFornecedor;

  FieldTransportadora get fieldTransportadora => _fieldTransportadora;
  set fieldTransportadora(FieldTransportadora fieldTransportadora) =>
      _fieldTransportadora = fieldTransportadora;

  FieldColaborador get fieldColaborador => _fieldColaborador;
  set fieldColaborador(FieldColaborador fieldColaborador) =>
      _fieldColaborador = fieldColaborador;

  FieldContador get fieldContador => _fieldContador;
  set fieldContador(FieldContador fieldContador) =>
      _fieldContador = fieldContador;
...
class FieldId extends FieldWidgets<Pessoa> {
  FieldId([Pessoa pessoa])
      : super(object: pessoa, label: 'Id', value: pessoa?.id);
...
class FieldNome extends FieldWidgets<Pessoa> {
  FieldNome([Pessoa pessoa])
      : super(object: pessoa, label: 'Nome', value: pessoa?.nome);
...
class FieldSite extends FieldWidgets<Pessoa> {
  FieldSite([Pessoa pessoa])
      : super(object: pessoa, label: 'Site', value: pessoa?.site);
