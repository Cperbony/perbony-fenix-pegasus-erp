...
class BancoFieldsLista extends BancoFields {
  final GlobalKey<ScaffoldState> scaffoldKeyBancoListaPage =
      GlobalKey<ScaffoldState>();
}

/// Classe que declara e disponibiliza os FieldWidgets
class BancoFields {
  FieldWidgets<Banco> _fieldId, _fieldCodigo, _fieldNome, _fieldUrl;
...
class FieldId extends FieldWidgets<Banco> {
  FieldId([Banco banco]) : super(object: banco, label: 'Id', value: banco?.id);
