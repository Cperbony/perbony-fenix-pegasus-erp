...
import 'package:perboni_erp_fenix/src/model/pessoa_contato.dart';
...
class PessoaContatoFieldsPersiste extends PessoaContatoFieldsLista {
  ...
  final GlobalKey<FormState> _formKeyPessoaContatoPersistePage =
      GlobalKey<FormState>();
...
class PessoaContatoFieldsLista extends PessoaContatoFields {
  final GlobalKey<ScaffoldState> scaffoldKeyPessoaContatoListaPage =
      GlobalKey<ScaffoldState>();
}

/// Classe que declara e disponibiliza os FieldWidgets
class PessoaContatoFields {
  FieldWidgets<PessoaContato> _fieldId,
      _fieldIdPessoa,
      _fieldEmail,
      _fieldNome,
      _fieldObservacao;
  ...
  set fieldObservacao(FieldObservacao fieldObservacao) =>
      _fieldObservacao = fieldObservacao;
...
class FieldId extends FieldWidgets<PessoaContato> {
  FieldId([PessoaContato pessoaContato])
      : super(object: pessoaContato, label: 'Id', value: pessoaContato?.id);
...
class FieldNome extends FieldWidgets<PessoaContato> {
  FieldNome([PessoaContato pessoaContato])
      : super(object: pessoaContato, label: 'Nome', value: pessoaContato?.nome);
