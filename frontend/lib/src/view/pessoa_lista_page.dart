...
import 'package:perboni_erp_fenix/src/view/pessoa_detalhe_page.dart';
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    Object itemSelecionado =
                        PessoaController.pessoaItemLista(index);
                    return PessoaController.pessoaFieldsLista.fieldId
                        .onDismissible(
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          leading: PessoaController
                              .pessoaFieldsLista.fieldId.circleAvatar,
                          title:
                              PessoaController.pessoaFieldsLista.fieldNome.text,
                          subtitle: PessoaController
                              .pessoaFieldsLista.fieldEmail.text,
                          trailing: PessoaController
                              .pessoaFieldsLista.fieldTipo.circleAvatar,
                        ),
                      ),
                            ...
                            ?.showSnackBar(SnackBar(
                                ...
                                action: SnackBarAction(
                                    ...
                                    onPressed: () {
                                      ...
                                      PessoaController
                                          .refrescarTela(); // .pessoaListando.refresh();
                                    })));
                      },
                    );
                  },
