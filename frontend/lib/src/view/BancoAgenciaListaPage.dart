      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: BancoAgenciaController.bancoAgenciaListando.items == null
              ...
              : ListView.builder(
                  itemCount: BancoAgenciaController
                          .bancoAgenciaListando.items?.length ??
                      0,
                  itemBuilder: (BuildContext context, int index) {
                    Object bancoAgenciaSelecionado =
                        bancoAgenciaController.child(index);
                    return BancoAgenciaController.bancoAgenciaListando.numero
                        .onDismissible(
                      child: Container(
                            ...
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (BuildContext context) =>
                                    BancoAgenciaDetalhePage(
                                        bancoAgencia:
                                            bancoAgenciaSelecionado)));
                          },
                          leading: BancoAgenciaController
                              .bancoAgenciaListando.numero.circleAvatar,
                          title: BancoAgenciaController
                              .bancoAgenciaListando.nome.text,
                          subtitle: BancoAgenciaController
                              .bancoAgenciaListando.gerente.text,
                          trailing: BancoAgenciaController
                              .bancoAgenciaListando.numero.circleAvatar,
                        ),
                      ),
                      dismissed: (DismissDirection direction) {
                        BancoAgenciaController.excluir(bancoAgenciaSelecionado)
                            .then((_) {
                          BancoAgenciaController.bancoAgenciaListando.refresh();
                        });
                        BancoAgenciaController
                            .bancoAgenciaListando.scaffoldKey.currentState
