...
import 'Banco_detalhe_page.dart';
    ...
    return Theme(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
            //https://www.youtube.com/watch?v=2uaoEDOgk_I
          ...
          child: BancoController.listaBanco == null
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    Object bancoSelecionado =
                        bancoController.bancoItemLista(index);
                    return BancoController.bancoFieldsLista.fieldCodigo
                        .onDismissible(
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          leading: BancoController
                              .bancoFieldsLista.fieldCodigo.circleAvatar,
                          title:
                              BancoController.bancoFieldsLista.fieldNome.text,
                          subtitle:
                              BancoController.bancoFieldsLista.fieldUrl.text,
                          trailing: BancoController
                              .bancoFieldsLista.fieldCodigo.circleAvatar,
                        ),
                      ),
                            ...
                            ?.showSnackBar(SnackBar(
                                ...
                                action: SnackBarAction(
                                    ...
                                    onPressed: () {
                                      ...
                                      BancoController
                                          .refrescarTela(); // .bancoListando.refresh();
                                    })));
                      },
                    );
                  },
