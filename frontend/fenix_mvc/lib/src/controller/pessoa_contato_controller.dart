...
import 'package:perboni_erp_fenix/src/service/pessoa_service.dart';
import 'package:perboni_erp_fenix/src/view/field_widgets/pessoa_contato_fields.dart';
...
class PessoaContatoController extends ControllerMVC {
  ...
  static Future<List<PessoaContato>> getListaPessoaContato() async {
    List<PessoaContato> listaPessoaContato =
        await PessoaService.consultarListaContato();
  ...
  static PessoaContatoFieldsLista get pessoaContatoFieldsLista =>
      _pessoaContatoFieldsLista;
  static PessoaContatoFieldsLista _pessoaContatoFieldsLista =
      PessoaContatoFieldsLista();

  static PessoaContatoFieldsPersiste get pessoaContatoFieldsPersiste =>
      _pessoaContatoFieldsPersiste;
  static PessoaContatoFieldsPersiste _pessoaContatoFieldsPersiste =
      PessoaContatoFieldsPersiste();
}
