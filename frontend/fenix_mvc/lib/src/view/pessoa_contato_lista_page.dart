...
import 'package:perboni_erp_fenix/src/controller/pessoa_contato_controller.dart';
import 'package:perboni_erp_fenix/src/view/pessoa_contato_detalhe_page.dart';
...
class _PessoaContatoListaState extends StateMVC<PessoaContatoListaPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: Scaffold(
        key: PessoaContatoController
            .pessoaContatoFieldsLista.scaffoldKeyPessoaContatoListaPage,
        ...
        body: SafeArea(
          child: PessoaContatoController.listaPessoaContato == null
              ...
              : ListView.builder(
                  itemCount:
                      PessoaContatoController.listaPessoaContato?.length ?? 0,
                  itemBuilder: (BuildContext context, int index) {
                    Object pessoaContatoSelecionado =
                        PessoaContatoController.pessoaContatoItemLista(index);
                    return PessoaContatoController
                        .pessoaContatoFieldsLista.fieldId
                        .onDismissible(
                      child: Container(
                            ...
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (BuildContext context) =>
                                    PessoaContatoDetalhePage(
                                        pessoaContato:
                                            pessoaContatoSelecionado)));
                          },
                          leading: PessoaContatoController
                              .pessoaContatoFieldsLista.fieldId.circleAvatar,
                          title: PessoaContatoController
                              .pessoaContatoFieldsLista.fieldNome.text,
                          subtitle: PessoaContatoController
                              .pessoaContatoFieldsLista.fieldEmail.text,
                          trailing: PessoaContatoController
                              .pessoaContatoFieldsLista.fieldId.circleAvatar,
                        ),
                      ),
                      dismissed: (DismissDirection direction) {
                        PessoaContatoController.excluir(
                                pessoaContatoSelecionado)
                            .then((_) {
                          PessoaContatoController.refrescarLista();
                        });
                        PessoaContatoController
                            .pessoaContatoFieldsLista
                            .scaffoldKeyPessoaContatoListaPage
                            .currentState //https://api.flutter.dev/flutter/material/ScaffoldState-class.html
                            ?.showSnackBar(SnackBar(
                                ...
                                action: SnackBarAction(
                                    ...
                                    onPressed: () {
                                      ...
                                      PessoaContatoController
                                          .refrescarTela(); // .pessoaContatoListando.refresh();
                                    })));
                      },
                    );
                  },
