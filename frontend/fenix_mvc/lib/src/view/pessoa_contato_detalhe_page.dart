  ...
  Widget build(BuildContext context) {
    return Theme(
        ...
        child: Scaffold(
            appBar: AppBar(
                title:
                    PessoaContatoController.pessoaContatoFields.fieldNome.text,
                actions: [
                  FlatButton(
                      ...
                      onPressed: () {
                        showBox(text: 'Exclui esse contato?', context: context)
                            .then((bool delete) {
                          if (delete)
                            PessoaContatoController.excluir(pessoaContato)
                                .then((bool delete) {
                              if (delete)
                ...
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (BuildContext context) =>
                        PessoaContatoPersistePage(
                            ...
                            title: 'Editar um Contato')));
              }),
            ),
            body: CustomScrollView(slivers: <Widget>[
              SliverList(
                delegate: SliverChildListDelegate(<Widget>[
                  PessoaContatoController.pessoaContatoFields.fieldNome
                      .onListTile(tap: () {
                    editPessoaContato(pessoaContato, context);
                  }),
                  PessoaContatoController.pessoaContatoFields.fieldEmail
                      .onListTile(tap: () {
                    editPessoaContato(pessoaContato, context);
                  }),
                  PessoaContatoController.pessoaContatoFields.fieldObservacao
                      .onListTile(tap: () {
                    editPessoaContato(pessoaContato, context);
                  }),
                ]),
