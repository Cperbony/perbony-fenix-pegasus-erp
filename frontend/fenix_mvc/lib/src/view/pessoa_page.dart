...
import 'package:perboni_erp_fenix/src/view/pessoa_contato_lista_page.dart';
import 'package:perboni_erp_fenix/src/view/pessoa_juridica_persiste_page.dart';
import 'package:perboni_erp_fenix/src/view/pessoa_persiste_page.dart';
...
class PessoaPageState extends State<PessoaPage>
  ...
  void initState() {
    super.initState();
    _todasAsAbas.clear();
    _todasAsAbas.add(_Aba(
        icon: Icons.receipt,
        text: 'Detalhes',
        visible: true,
        pagina: PessoaPersistePage(pessoa: widget.pessoa)));
    _todasAsAbas.add(_Aba(
        icon: Icons.person,
        text: 'Pessoa Física',
        visible: false,
    ...
    _todasAsAbas.add(_Aba(
        ...
        visible: true,
        pagina: PessoaJuridicaPersistePage(pessoaJuridica: null)));
    _todasAsAbas.add(_Aba(
        icon: Icons.group,
        text: 'Contatos',
        visible: true,
    ...
    _todasAsAbas.add(_Aba(
        icon: Icons.place, text: 'Endereços', visible: true, pagina: null));
    _todasAsAbas.add(_Aba(
        icon: Icons.phone, text: 'Telefones', visible: true, pagina: null));
