                  ...
                  FlatButton(
                      ...
                      onPressed: () {
                        showBox(text: 'Exclui essa Agencia?', context: context)
                            .then((bool delete) {
                          if (delete)
                            BancoAgenciaController.excluir(bancoAgencia)
                                .then((bool delete) {
                              if (delete)
                                BancoAgenciaController.bancoAgenciaListando
                                    .refresh();
            ...
            body: CustomScrollView(slivers: <Widget>[
              SliverList(
                delegate: SliverChildListDelegate(<Widget>[
                  BancoAgenciaController.bancoAgenciaEditando.idBanco
                      .onListTile(tap: () {
                    editBancoAgencia(bancoAgencia, context);
                  }),
                  BancoAgenciaController.bancoAgenciaEditando.numero.onListTile(
                      tap: () {
                    editBancoAgencia(bancoAgencia, context);
                  }),
                  BancoAgenciaController.bancoAgenciaEditando.digito.onListTile(
                      tap: () {
                    editBancoAgencia(bancoAgencia, context);
                  }),
                  BancoAgenciaController.bancoAgenciaEditando.nome.onListTile(
                      tap: () {
                    editBancoAgencia(bancoAgencia, context);
                  }),
                  BancoAgenciaController.bancoAgenciaEditando.gerente
                      .onListTile(tap: () {
                    editBancoAgencia(bancoAgencia, context);
                  }),
                  BancoAgenciaController.bancoAgenciaEditando.contato
                      .onListTile(tap: () {
                    editBancoAgencia(bancoAgencia, context);
                  }),
                  BancoAgenciaController.bancoAgenciaEditando.telefone
                      .onListTile(tap: () {
                    editBancoAgencia(bancoAgencia, context);
                  }),
                  BancoAgenciaController.bancoAgenciaEditando.observacao
                      .onListTile(tap: () {
                    editBancoAgencia(bancoAgencia, context);
                  }),
                ]),
