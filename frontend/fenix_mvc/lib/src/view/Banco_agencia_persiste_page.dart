            ...
            child: ListView(
              children: [
                Row(
                  children: <Widget>[
                    Expanded(
                      flex: 1,
                      child: Container(
                          child: BancoAgenciaController
                              .bancoAgenciaPersistindo.idBanco.textFormField),
                    ),
                    Expanded(
                      flex: 0,
                      child: IconButton(
                        ...
                        onPressed: () async {
                          final String bancoSelecionado =
                              await showSearch<String>(
                            context: context,
                            delegate: DataSearch(),
                          );
                          if (bancoSelecionado != null) {
                            BancoAgenciaController.bancoAgenciaPersistindo
                ...
                BancoAgenciaController
                    .bancoAgenciaPersistindo.numero.textFormField,
                BancoAgenciaController
                    .bancoAgenciaPersistindo.digito.textFormField,
                BancoAgenciaController
                    .bancoAgenciaPersistindo.nome.textFormField,
                BancoAgenciaController
                    .bancoAgenciaPersistindo.telefone.textFormField,
                BancoAgenciaController
                    .bancoAgenciaPersistindo.contato.textFormField,
                BancoAgenciaController
                    .bancoAgenciaPersistindo.observacao.textFormField,
                BancoAgenciaController
                    .bancoAgenciaPersistindo.gerente.textFormField,
              ],
            )),
      ),
    );
